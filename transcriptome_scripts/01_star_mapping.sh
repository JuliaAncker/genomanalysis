...
path_index=/home/juliaa/genomanalys/Data/Assembly/transcriptome_assembly/star_rp/star_index_rp
...
output_dir=/home/juliaa/genomanalys/Data/Assembly/transcriptome_assembly/02_star_rp/mapping_rp
...
for ((x=0; x<${#forward_files[@]}; x++)); do
	...
	star --runThreadN 8 --genomeDir $path_index --readFilesCommand zcat --readFilesIn "$forward_file" "$reverse_file" --outSAMstrandField intronMotif --outFileNamePrefix $output_dir/$file_name
